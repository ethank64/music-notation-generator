...
import { generateNotation, usingMock } from './api/notationApi'
  ...
  return (
    <div className="app">
      ...
      <footer className="app__footer">
        ...
        .{' '}
        {usingMock
          ? 'Notation is currently mocked — set VITE_USE_MOCK=false to use the live model.'
          : 'Notation generated by the live model.'}
      </footer>
    </div>
  )
}
